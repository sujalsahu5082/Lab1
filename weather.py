...
print("Temperature for keyboard input coefficients at time",
      time_keyboard, "hours:",
...
print("Temperature for file input coefficients at time",
      time_file, "hours:",
